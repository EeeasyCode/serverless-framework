...
s3Zip.archive = function (opts, folder, filesS3, originalName, filesZip) {
  const self = this;
...
s3Zip.archiveStream = function (stream, filesS3, filesZip, originalName) {
  const self = this;
